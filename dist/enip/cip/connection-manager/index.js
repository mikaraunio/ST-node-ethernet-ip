 ...
 */
const build_forwardOpen = (toRPI = 8000, netConnParams = 0x43f4, timeOutMs = 1000, timeOutMult = 32, connectionSerial = 0x4242, TOconnectionID = getRandomInt(2147483647)) => {
    ...
    if (toRPI < 8000 || typeof toRPI !== "number")
